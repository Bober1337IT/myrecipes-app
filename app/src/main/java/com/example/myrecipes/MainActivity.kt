...
//                                        tint = MaterialTheme.colorScheme.onSurface
//                                    )
//                                    Text(text = "Export", color = MaterialTheme.colorScheme.onSurface)
//                                }
//                            },
//                            onClick = {
//
                ...
                items(fileNames) { fileName ->
                    Button(
                        ...
                        colors = ButtonDefaults.buttonColors(
                            containerColor = if (deleteFileMode) Color.Red else MaterialTheme.colorScheme.primary,
                            contentColor = if (deleteFileMode) Color.White else MaterialTheme.colorScheme.onPrimary
                        ),
                        modifier = Modifier
                            .padding(8.dp)
                            .fillMaxWidth()
